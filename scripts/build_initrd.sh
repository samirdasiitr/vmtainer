...
for applet in sh echo cat sleep mkdir mount mountpoint umount pivot_root chroot head mknod halt poweroff reboot dd hostname ls ip ifconfig route grep sed chmod env; do
